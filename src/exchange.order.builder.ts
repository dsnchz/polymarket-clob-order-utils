...
import { SignTypedDataVersion, TypedDataUtils, type TypedMessage } from "@metamask/eth-sig-util";
...
import type { EIP712TypedData, MessageTypes } from "./model/eip712.model";
import type { Order, OrderData, OrderHash, OrderSignature, SignedOrder } from "./model/order.model";
...
export class ExchangeOrderBuilder {
  ...
  buildOrderHash(orderTypedData: EIP712TypedData): OrderHash {
    ...
    return ZX + TypedDataUtils.eip712Hash(message, SignTypedDataVersion.V4).toString("hex");
  }
}
